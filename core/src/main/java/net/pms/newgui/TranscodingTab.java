...
public class TranscodingTab {
	...
	public JComponent buildCommon() {
		...
		builder.addLabel(Messages.getString("NetworkTab.7").replaceAll("%d", "" + Runtime.getRuntime().availableProcessors()), FormLayoutUtil.flip(cc.xy(2, 5), colSpec, orientation));
