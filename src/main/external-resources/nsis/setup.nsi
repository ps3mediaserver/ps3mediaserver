...
Section "Program Files"
  SetOutPath "$INSTDIR"
  SetOverwrite on
  File /r /x ".svn" /x "*.jar" /x "*.conf" /x "*.zip" /x "*.dll" /x "third-party" "${PROJECT_BASEDIR}\src\main\external-resources\plugins"
  File /r /x ".svn" "${PROJECT_BASEDIR}\src\main\external-resources\documentation"
  File /r /x ".svn" "${PROJECT_BASEDIR}\src\main\external-resources\renderers"
  File /r /x ".svn" "${PROJECT_BINARIES}\win32"
