...
public interface PmsPluginBase {
	...
	/**
	 * The name of the plugin. Once the plugin has been released, this name
	 * shouldn't be changed, as it gets used as an identifier on rare occasions
	 * (for FileImportPlugins)
	 * 
	 * @return plugin name
	 */
