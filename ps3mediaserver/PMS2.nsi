...
VIAddVersionKey "ProductName" "Java PS3 Media Server"
VIAddVersionKey "Comments" ""
VIAddVersionKey "CompanyName" "A. Brochard"
VIAddVersionKey "LegalTrademarks" ""
VIAddVersionKey "LegalCopyright" ""
VIAddVersionKey "FileDescription" "Java PS3 Media Server"
VIAddVersionKey "FileVersion" "1.0.0"
VIProductVersion "1.0.0.1"
 
!define CLASSPATH "lib/pms.jar;lib/commons-logging-api-1.0.4.jar;lib/java-unrar-0.2.jar;lib/nanoxml-2.2.3.jar;lib/entagged-cvs.jar;lib/forms-1.2.1.jar;lib/looks-2.2.1.jar;lib/jna.jar"
...
Section ""
  ...
  ${GetParameters} $1
  StrCpy $0 '"$R0" -Xmx768M -Djava.net.preferIPv4Stack=true -Djava.encoding=UTF-8 -classpath "${CLASSPATH}" ${CLASS} $1'
