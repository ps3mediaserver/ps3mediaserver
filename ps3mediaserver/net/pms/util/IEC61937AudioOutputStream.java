 ...
 * DTS-HD cannot work because it needs a LPCM stream of 2 channels sampled at 192kHz = 6.1Mbits/s. (8 channels for TrueHD, 24Mbits !!!)
			...
			if (framesize == 0 || dtsHD) {
				...
				if (usepreamble && preamble == null) {
					...
					if (dtsHD) {
						...
						preamble[4] = 0;
						switch (blocks) {
							case 512 >> 5:  preamble[5] = 11; break;
							case 1024 >> 5: preamble[5] = 12; break;
							case 2048 >> 5: preamble[5] = 13; break;
						}
					}
					if (dtsHD) {
						...
						byte subtype = 0x0;
						switch (period) {
						     case 512:   subtype = 0x0; break;
						     case 1024:  subtype = 0x1; break;
						     case 2048:  subtype = 0x2; break;
						     case 4096:  subtype = 0x3; break;
						     case 8192:  subtype = 0x4; break;
						     case 16384: subtype = 0x5; break;
						}
						preamble[4] = subtype;
