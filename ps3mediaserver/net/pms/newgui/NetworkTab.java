...
public class NetworkTab {
	...
	public JComponent build() {
       ...
       final KeyedComboBoxModel kcbm = new KeyedComboBoxModel(new Object[] { "en", "fr", "de", "es", "it", "se", "ru" }, new Object[] { Messages.getString("NetworkTab.9"), Messages.getString("NetworkTab.10"), "German", "Spanish", "Italian", "Swedish", "Russian" }); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$ //$NON-NLS-10$ //$NON-NLS-11$
